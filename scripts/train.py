...
for epoch in range(num_epochs):
    ...
    torch.save(visual_inertial_network.state_dict(), "/home/jc-merlab/RBE549_Computer_Vision_P4_Ph2/models/visual_inertial_model/visual_inertial_model_epoch_{}.pth".format(epoch + 1))
        ...
        # train_inertial_network(inertial_network, inertial_optimizer, imu_seq, gt_rel_pose)
        # train_visual_inertial_network(visual_inertial_network, visual_inertial_optimizer, img1, img2, imu_seq, gt_rel_pose)
